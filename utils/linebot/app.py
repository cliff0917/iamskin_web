...
channel_secret = os.getenv("LINE_CHANNEL_SECRET", globals.config["LINE_CHANNEL_SECRET"])
channel_access_token = os.getenv("LINE_CHANNEL_ACCESS_TOKEN", globals.config["LINE_CHANNEL_ACCESS_TOKEN"])
imgur_client_id = os.getenv("IMGUR_CLIENT_ID", globals.config["IMGUR_CLIENT_ID"])
